...
// Helper function to get GST percentage for a specific item
...
// Helper function to check if any item has GST enabled
...
function updateTotal() {
    ...
    if (discountApplied) {
        ...
        if (gstApplicable) {
            // Calculate GST based on items that have GST enabled
            let totalWithGST = 0;
            let subtotal = 0;
            const allQtys = document.querySelectorAll('[id^="qty-"]');
            allQtys.forEach(span => {
